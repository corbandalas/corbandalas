...
public class AboutView extends VerticalLayout {
    ...
    public AboutView() {
        ...
        Label label = new Label("\n\n Всем привет! \n\n" +
                "Меня зовут Терещенко Артем aka corbandalas, я backend Java-программист из Донецка с опытом работы на различных финтех проектах с 2006 года, страстный коллекционер почтовых марок и конвертов на тему Донбасса, а также винила группы \"Кино\" и Lego на тему Гарри Поттера, фанат игры на укулеле, немного поэт и просто человек, который любит жить в своем родном городе несмотря на войну, обстрелы, взрывы и невзгоды, которые \"донецкие\" переживают последние 10 лет. \n\n" +
