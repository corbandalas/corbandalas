package com.corbandalas.web.views.admin;
...
public class AdminLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        ...
        Scroller scroller = createScoller();

        addToDrawer(header, scroller, createFooter());

    }

    private Scroller createScoller() {
    ...
    private AppNav createNavigation() {
        ...
        if (accessChecker.hasAccess(PostListView.class)) {
            nav.addItem(new AppNavItem("Посты", PostListView.class,  LineAwesomeIcon.FILE.create()));

        }
        if (accessChecker.hasAccess(AboutView.class)) {
            nav.addItem(new AppNavItem("Пользователи", AboutView.class,  LineAwesomeIcon.SUN.create()));
